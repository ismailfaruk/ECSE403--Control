...
struct Parameters_model_ {
  ...
  real_T HILInitialize_POFinal;        /* Expression: final_pwm_outputs
                                        * Referenced by: '<Root>/HIL Initialize'
                                        */
  real_T AngleGain_Gain;               /* Expression: 1
                                        * Referenced by: '<Root>/Angle Gain'
                                        */
  real_T positionGain_Gain;            /* Expression: 1/44
  ...
  real_T Integrator_IC;                /* Expression: 0
                                        ...
                                        */
  real_T l2_Gain;                      /* Expression: 0.00098
...
extern struct RT_MODEL_model *const model_M;
