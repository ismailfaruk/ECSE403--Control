 ...
 */
#ifndef RTW_HEADER_model_sim_h_
#define RTW_HEADER_model_sim_h_
#ifndef model_sim_COMMON_INCLUDES_
# define model_sim_COMMON_INCLUDES_
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* model_sim_COMMON_INCLUDES_ */

#include "model_sim_types.h"
...
#define model_sim_rtModel              RT_MODEL_model_sim
...
} ContinuousStates_model_sim;

/* State derivatives (auto storage) */
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
  real_T TransferFcn1_CSTATE;          /* '<Root>/Transfer Fcn1' */
} StateDerivatives_model_sim;

/* State disabled  */
typedef struct {
  boolean_T TransferFcn_CSTATE;        /* '<Root>/Transfer Fcn' */
  boolean_T TransferFcn1_CSTATE;       /* '<Root>/Transfer Fcn1' */
} StateDisabled_model_sim;
...
#define rtB                            model_sim_B
#define BlockIO                        BlockIO_model_sim
#define rtX                            model_sim_X
#define ContinuousStates               ContinuousStates_model_sim
#define rtP                            model_sim_P
#define Parameters                     Parameters_model_sim
#define rtDWork                        model_sim_DWork
#define D_Work                         D_Work_model_sim

/* Parameters (auto storage) */
struct Parameters_model_sim_ {
  real_T positionGain1_Gain[4];        /* Expression: [-15.0542 -9.72 -23.0187 -1.8513]
...
extern Parameters_model_sim model_sim_P;

/* Block signals (auto storage) */
extern BlockIO_model_sim model_sim_B;

/* Continuous states (auto storage) */
extern ContinuousStates_model_sim model_sim_X;

/* Block states (auto storage) */
extern D_Work_model_sim model_sim_DWork;

/* Model entry point functions */
extern void model_sim_initialize(boolean_T firstTime);
extern void model_sim_output(int_T tid);
extern void model_sim_update(int_T tid);
extern void model_sim_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_model_sim *const model_sim_M;
