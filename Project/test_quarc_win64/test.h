...
#define test_rtModel                   RT_MODEL_test
...
} ContinuousStates_test;

/* State derivatives (auto storage) */
typedef struct {
  real_T TransferFcn_CSTATE;           /* '<Root>/Transfer Fcn' */
  real_T TransferFcn1_CSTATE;          /* '<Root>/Transfer Fcn1' */
} StateDerivatives_test;
...
#define rtB                            test_B
#define BlockIO                        BlockIO_test
#define rtX                            test_X
#define ContinuousStates               ContinuousStates_test
#define rtP                            test_P
#define Parameters                     Parameters_test
#define rtDWork                        test_DWork
#define D_Work                         D_Work_test
...
/* Block signals (auto storage) */
extern BlockIO_test test_B;

/* Continuous states (auto storage) */
extern ContinuousStates_test test_X;

/* Block states (auto storage) */
extern D_Work_test test_DWork;

/* Model entry point functions */
extern void test_initialize(boolean_T firstTime);
extern void test_output(int_T tid);
extern void test_update(int_T tid);
