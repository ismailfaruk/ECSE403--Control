...
MODEL                = test
MODULES              = rtGetInf.c rtGetNaN.c rt_nonfinite.c test_data.c test_main.c 
MAKEFILE             = test.mk
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);\\campus.mcgill.ca\EMF\ELE\frouss7\My Documents\403\Project\test_quarc_win64
