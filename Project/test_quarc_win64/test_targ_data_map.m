  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% test_P.TransferFcn1_A
	  section.data(22).logicalSrcIdx = 23;
	  section.data(22).dtTransOffset = 24;
	
	  ;% test_P.TransferFcn1_C
  ...
  ;%*******************
    ...
    ;%
    ;% Auto data (test_DWork)
    ;%
      section.nData     = 6;
      section.data(6)  = dumData; %prealloc
      
	  ;% test_DWork.HILInitialize_AIMinimums
	  section.data(1).logicalSrcIdx = 0;
	  section.data(1).dtTransOffset = 0;
	
	  ;% test_DWork.HILInitialize_AIMaximums
	  section.data(2).logicalSrcIdx = 1;
	  section.data(2).dtTransOffset = 4;
	
	  ;% test_DWork.HILInitialize_AOMinimums
	  section.data(3).logicalSrcIdx = 2;
	  section.data(3).dtTransOffset = 8;
	
	  ;% test_DWork.HILInitialize_AOMaximums
	  section.data(4).logicalSrcIdx = 3;
	  section.data(4).dtTransOffset = 12;
	
	  ;% test_DWork.HILInitialize_AOVoltages
	  section.data(5).logicalSrcIdx = 4;
	  section.data(5).dtTransOffset = 16;
	
	  ;% test_DWork.HILInitialize_FilterFrequency
	  section.data(6).logicalSrcIdx = 5;
	  ...
	  ;% test_DWork.Derivative_RWORK.TimeStampA
	  section.data(1).logicalSrcIdx = 8;
	  section.data(1).dtTransOffset = 0;
	
	  ;% test_DWork.Derivative1_RWORK.TimeStampA
	  ...
	  ;% test_DWork.Angle_PWORK.LoggedData
	  section.data(1).logicalSrcIdx = 10;
	  section.data(1).dtTransOffset = 0;
	
	  ;% test_DWork.HILWriteAnalog_PWORK
	  section.data(2).logicalSrcIdx = 11;
	  section.data(2).dtTransOffset = 1;
	
	  ;% test_DWork.Position_PWORK.LoggedData
	  section.data(3).logicalSrcIdx = 12;
	  section.data(3).dtTransOffset = 2;
	
	  ;% test_DWork.Scope_PWORK.LoggedData
	  section.data(4).logicalSrcIdx = 13;
	  section.data(4).dtTransOffset = 3;
	
	  ;% test_DWork.Scope1_PWORK.LoggedData
	  ...
	  ;% test_DWork.HILInitialize_QuadratureModes
	  section.data(1).logicalSrcIdx = 15;
	  section.data(1).dtTransOffset = 0;
	
	  ;% test_DWork.HILInitialize_InitialEICounts
	  section.data(2).logicalSrcIdx = 16;
	  section.data(2).dtTransOffset = 4;
	
	  ;% test_DWork.HILReadEncoderTimebase_Buffer
  ...
  targMap.checksum0 = 3784546298;
  targMap.checksum1 = 1416022897;
  targMap.checksum2 = 4121089621;
  targMap.checksum3 = 1410388266;
