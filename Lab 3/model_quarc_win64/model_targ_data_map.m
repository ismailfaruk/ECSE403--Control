  ...
  ;%***********************
    ...
    ;%
	  ...
	  ;% model_P.SineWave_Amp
	  section.data(16).logicalSrcIdx = 15;
	  section.data(16).dtTransOffset = 15;
	
	  ;% model_P.SineWave_Bias
	  section.data(17).logicalSrcIdx = 16;
	  section.data(17).dtTransOffset = 16;
	
	  ;% model_P.SineWave_Freq
	  section.data(18).logicalSrcIdx = 17;
	  section.data(18).dtTransOffset = 17;
	
	  ;% model_P.SineWave_Phase
	  ...
	  ;% model_P.TransferFcn_A
	  section.data(24).logicalSrcIdx = 23;
	  section.data(24).dtTransOffset = 23;
	
	  ;% model_P.TransferFcn_C
  ...
  ;%*******************
    ...
    ;%
	  ...
	  ;% model_DWork.Derivative1_RWORK.TimeStampA
  ...
  targMap.checksum0 = 542600865;
  targMap.checksum1 = 1923316608;
  targMap.checksum2 = 1103018394;
  targMap.checksum3 = 3230226340;
